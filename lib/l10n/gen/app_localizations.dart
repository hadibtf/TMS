...
abstract class AppLocalizations {
  ...
  /// **'TMS - Train Metro Schedule'**
  String get appTitle;

  /// No description provided for @directionElGoliToNoor.
  ///
  /// In en, this message translates to:
  /// **'El-Goli to Noor'**
  String get directionElGoliToNoor;

  /// No description provided for @directionNoorToElGoli.
  ///
  /// In en, this message translates to:
  /// **'Noor to El-Goli'**
  String get directionNoorToElGoli;
  ...
  /// No description provided for @noMoreTrains.
  ///
  /// In en, this message translates to:
  /// **'No more trains today'**
  String get noMoreTrains;
  ...
  /// Subtitle under station name on card
  ///
  /// In en, this message translates to:
  /// **'{stationName} Railway Station'**
  String stationSubtitle(Object stationName);

  /// Countdown badge displaying minutes and seconds until next train
  ///
  /// In en, this message translates to:
  /// **'{minutes}m{secondsPadded}s'**
